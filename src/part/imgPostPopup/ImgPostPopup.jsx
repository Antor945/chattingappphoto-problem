...
const ImgPostPopup = ({ handleCaption, handleCancel, taitle, style }) => {
    ...
    return (
        <div className=' absolute left-0 bg-black text-white md:p-10 bg-gradient-to-t
          from-orange-300 via-blue-600 rounded-2xl shadow-2xl md:h-screen md:w-screen top-0 flex
           justify-center items-center z-10 px-3 py-7 md:py-0'>
            <div>
                ...
                <div className=' text-center'>
                    ...
                    <h2 className=' font-Poppins text-black font-medium text-start ml-5'>Caption</h2>
