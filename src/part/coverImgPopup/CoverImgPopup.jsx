...
const CoverImgPopup = ({handleCancel}) => {
            ...
            <div>
                <div className=' flex justify-center items-center'>
                    <div className=' flex flex-col items-center '>
                        <h1 className=' font-medium md:text-[34px] text-white text-center mb-3 font-Poppins capitalize text-2xl'>
