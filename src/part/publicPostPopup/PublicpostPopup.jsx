...
import { getDatabase, push, set, ref as sref } from 'firebase/database';
import { useSelector } from 'react-redux';


const PublicpostPopup = ({ handleCancel, handleCaption }) => {
    ...
    return (
        <div className=' fixed bg-black h-screen text-white md:p-10 bg-gradient-to-t
          from-orange-300 via-blue-600  shadow-2xl md:h-screen  top-0 flex
           justify-center items-center z-10  md:py-0  w-full left-0'>
            <div>
                <div className=' flex justify-center items-center'>
                    <div className=' flex flex-col items-center '>
                        <h1 className=' font-medium md:text-[34px] text-secoundry mb-3 font-Poppins capitalize text-2xl'>
                            create post
                        </h1>
                        {
                            image &&
                            <div>
                                ...
                                <div className={`overflow-hidden border-2 border-secoundry`}>
                                    <div
                ...
                <div className=' text-center'>
                    ...
                    <div className=' flex flex-col gap-3'>
                        <div>
                            <textarea name="" id="" type="text" onChange={(e) => setCaption(e.target.value)} className=' outline-none md:w-80 w-64 py-3 font-Poppins
...
export default PublicpostPopup